...
ALTER TABLE [Businesses] ADD [ImageUrl] nvarchar(500) NULL;
GO

ALTER TABLE [Businesses] ADD [IsOpen] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [Businesses] ADD [Location] nvarchar(100) NOT NULL DEFAULT N'';
GO

ALTER TABLE [Businesses] ADD [Rating] float NOT NULL DEFAULT 0.0E0;
GO

ALTER TABLE [Businesses] ADD [Tag] nvarchar(50) NULL;
GO

ALTER TABLE [BusinessCategories] ADD [Description] nvarchar(300) NULL;
GO

ALTER TABLE [BusinessCategories] ADD [IconUrl] nvarchar(500) NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260826174815_AddHomeAndBusinessSchema', N'8.0.8');
GO
...
IF @var2 IS NOT NULL EXEC(N'ALTER TABLE [Businesses] DROP CONSTRAINT [' + @var2 + '];');
...
IF @var3 IS NOT NULL EXEC(N'ALTER TABLE [Businesses] DROP CONSTRAINT [' + @var3 + '];');
